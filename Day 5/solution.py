...
def run_program(inputs):
    ...
    while not exit_program:
        ...
        if instruction == HALT.opcode:
            ...
            inputs[inputs[instruction_pointer + 1]] = int(input("What is your input?: "))
            ...
            if resolve_parameter(inputs, instruction + 1, mode[-1]) < resolve_parameter(inputs, instruction + 2, mode[-2]):
